...
namespace DesignComp.Scripts
{
    public class DesignCompDisplay : MonoBehaviour
    {
        ...
        private readonly Dictionary<string, List<GameObject>> cachedObjectsByName = new();
        ...
        private GameObject[] FindGameObjectsByName(string name)
        {
            ...
            if (cachedObjectsByName.TryGetValue(name, out var cachedObjects))
            {
            ...
            // キャッシュに保存
            cachedObjectsByName[name] = matchingObjects;
